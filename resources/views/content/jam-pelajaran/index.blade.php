    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" id="imporPdHeader">
                <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#modal-importjam"
                    onclick="viewimport()">
                    <i class="fas fa-file-import"></i>&nbsp; Import Jam Pelajaran
                </button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">Jam Pelajaran</td>
                            <td class="text-center">
                                <button type="button" class="btn btn-sm btn-danger"
                                    onclick="hapusRuang('1', 'Ruang 32')">
...
<div class="modal fade" id="modal-importjam">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Import Data Jam Pelajaran</h4>
        ...
        <script>
            ...
            function hapusRuang(id, nama) {
                ...
                swalWithBootstrapButtons.fire({
                    title: "Nonaktifkan data Jam Pelajaran <span class='text-danger'>" + nama + "</span> ?",
                    text: "Data jam pelajaran akan dinonaktifkan !",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        swalWithBootstrapButtons.fire({
                            title: "Berhasil!",
                            text: "Data jam pelajaran " + nama + " berhasil dinonaktifkan.",
                            icon: "success"
                        });
                    } else if (
