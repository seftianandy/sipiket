...
@stop
    ...
    @push('script')
        <script>
            ...
            function viewimport() {
                $.get("{{ url('kelas/import-view') }}", {}, function (data, status) {
            ...
            function hapusRuang(id, nama) {
                ...
                swalWithBootstrapButtons.fire({
                    title: "Nonaktifkan data kelas <span class='text-danger'>" + nama + "</span> ?",
                    text: "Data kelas akan dinonaktifkan !",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        swalWithBootstrapButtons.fire({
                            title: "Berhasil!",
                            text: "Data kelas " + nama + " berhasil dinonaktifkan.",
                            icon: "success"
                        });
                    } else if (
