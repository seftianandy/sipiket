    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" id="imporPdHeader">
                <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#modal-importmapel"
                    onclick="viewimport()">
                    <i class="fas fa-file-import"></i>&nbsp; Import Mata Pelajaran
                </button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">GURU PENGAMPU</td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detil Mata Pelajaran</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="detil-mapel">
...
<div class="modal fade" id="modal-importmapel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Import Data Mata Pelajaran</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
@stop
    ...
    @push('script')
        <script>
            ...
            function detil(id) {
                $.get("{{ url('mata-pelajaran/detil') }}/" + id, {}, function (data, status) {
                    $("#detil-mapel").html(data)
                })
            }

            function viewimport() {
                $.get("{{ url('mata-pelajaran/import-view') }}", {}, function (data, status) {
            ...
            function nonactivepd(id, nama) {
                ...
                swalWithBootstrapButtons.fire({
                    title: "Nonaktifkan mata pelajaran <span class='text-danger'>" + nama + "</span> ?",
                    text: "Data Mata Pelajaran akan dinonaktifkan !",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        swalWithBootstrapButtons.fire({
                            title: "Berhasil!",
                            text: "Mata Pelajaran " + nama + " berhasil dinonaktifkan.",
                            icon: "success"
                        });
                    } else if (
